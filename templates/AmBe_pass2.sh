...
/usr/bin/time --verbose --output=${OUTPUT_PATH}"time_pass2_"${RUN}"_"${SUBFILE}".log" /lstore/sno/stefan/rat/rat-6.15.0/bin/rat -d water-backg-v2 -i $RAT_INPUT -o $RAT_OUTPUT $RAT_MACRO
